...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "glass inline-flex h-10 items-center justify-center rounded-full p-1 text-muted-foreground",
      className,
    )}
    {...props}
  />
